...
const createHFRecognizerDownloadUrl = alphabet => `${URL_PREFIX}-recognizer-crnn.en/${VERSION_TAG}/xnnpack/${alphabet}/xnnpack_crnn_${alphabet}.pte`;
...
const createOCRObject = (recognizerSource, language) => {
  return {
 ...
 * @category OCR Supported Alphabets
 */
export const OCR_SIMPLIFIED_CHINESE = createOCRObject(RECOGNIZER_ZH_SIM_CRNN, 'chSim');
 ...
 * @category OCR Supported Alphabets
 */
export const OCR_SERBIAN_CYRILLIC = createOCRObject(RECOGNIZER_CYRILLIC_CRNN, 'rsCyrillic');

/**
 * @category OCR Supported Alphabets
 */
export const OCR_SERBIAN_LATIN = createOCRObject(RECOGNIZER_LATIN_CRNN, 'rsLatin');
