...
export const useTokenizer = ({
  ...
  const stateWrapper = fn => {
    return (...args) => {
      if (!isReady) throw new RnExecutorchError(RnExecutorchErrorCode.ModuleNotLoaded, 'The model is currently not loaded. Please load the model before calling this function.');
